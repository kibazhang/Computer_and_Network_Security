//written by Zaiwei Zhang   PUID:0025211831
/*
/ file : server.c
/------------------------------------------
...
int main(int argc, char *argv[])
{
    ...
    int numBytes = 0; 
    int senderBuffSize;
    char* str = malloc(MAX_DATA_SIZE * sizeof(char));
...
#output for some client test cases:
Connected from 128.46.4.85
RECEIVED: aa
SENT: aa
RECEIVED BYTES: 3

RECEIVED: aaaaaaaaaaaaaaaaaaaaaaaaaaaaa
SENT: aaaaaaaaaaaaaaaaaaaaaaaaaaaaa
RECEIVED BYTES: 30

RECEIVED: 
SENT: 
RECEIVED BYTES: 410
