...
#Screen output obtained by running the script
Confusion Test
The key used for testcase1: �oriarty
The key used for testcase2: mOriarty
The key used for testcase3: morkarty
The key used for testcase4: moria�ty
The key used for testcase5: moriarTy
Confusion Test: The average of the number of ciphertext bits changed for five test cases: 2987
Diffusion Test
Diffusion test 1
Diffusion test 2
Diffusion test 3
Diffusion test 4
Diffusion test 5
Diffusion Test: The average of the number of ciphertext bits changed for five test cases: 30
