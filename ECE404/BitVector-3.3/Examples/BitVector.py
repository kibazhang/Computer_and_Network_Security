...
__doc__ = '''
    ...
    CHANGE LOG:
       ...
       Version 3.3:
           ...
           allows a bit vector to be constructed directly from a chunk of
           bytes that you have read previously into your script. (2) A
           bugfix in the slice function for the case when the upper and the
           lower bounds of the slice range are identical. (3) A bugfix for
           the next_set_bit() method.
    ...
    CONSTRUCTING BIT VECTORS:
        ...
        @tagC10
        (C10) You can also construct a bit vector directly from a chunk of raw 
              bytes you previously created in your script.  This can be useful 
