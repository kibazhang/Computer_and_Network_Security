...
###  Medium strength encryption/decryption for secure message exchange for
###  fun.
...
###
###  The decrypted output is deposited in the file `message.txt'
...
check = 1
keys = [chr(m) + chr(n) for m in range(65,123) for n in range(65,123)]
for key in keys:
    print "input key = ",key
